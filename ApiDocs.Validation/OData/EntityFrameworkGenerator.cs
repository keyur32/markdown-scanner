...
namespace ApiDocs.Validation.OData
{
    ...
    {
        /// <summary>
        /// List of namespaces that should be added to the entity framework
        /// </summary>
        public string[] ExportNamespaces { get; internal set; }

        public string BaseUrl { get; internal set; }

        public DocSet Documents { get; set; }

        public EntityFrameworkGenerator(DocSet docs, string baseUrl, string[] exportNamespaces)
        {
            this.Documents = docs;
            this.BaseUrl = baseUrl;
            this.ExportNamespaces = exportNamespaces;
        }

        public static EntityFramework Generate(DocSet docs, string baseUrl, string[] exportedNamespaces = null)
        {
            EntityFrameworkGenerator generator = new EntityFrameworkGenerator(docs, baseUrl, exportedNamespaces);
            return generator.CreateEntityFrameworkFromDocs();
        }

        /// <summary>
        /// Generate a new EntityFramework instance from the documentation
        /// </summary>
        /// <returns></returns>
        public EntityFramework CreateEntityFrameworkFromDocs()
        {
            ...
            BuildEntityCollection(edmx, this.BaseUrl);

            // Add actions to the collection
            ProcessRestRequestPaths(edmx, this.BaseUrl);
        ...
        private Schema FindOrCreateSchemaForNamespace(string ns, EntityFramework edmx, bool overrideNamespaceFilter = false)
        {
            ...
            if (!overrideNamespaceFilter && this.ExportNamespaces != null && !this.ExportNamespaces.Contains(ns))
            {
                // Skip generating items in this namespace
                return null;
            }

            if (ns.Equals("odata", StringComparison.OrdinalIgnoreCase))
            {
                // Never generate items in the odata namespace
                return null;
            }
